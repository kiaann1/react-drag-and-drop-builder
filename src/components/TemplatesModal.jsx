  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div 
          className="fixed inset-0 backdrop-blur-sm bg-opacity-25 transition-all duration-300" 
          aria-hidden="true"
          onClick={onClose}
        ></div>
        ...
        <div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full sm:p-6 z-10">
          ...
          <div className="mb-6 space-y-4 relative z-10">
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 relative z-10"
              />
            ...
            <div className="flex flex-wrap gap-2 relative z-10">
              {templateCategories.map(category => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm font-medium transition-colors relative z-10 cursor-pointer ${
          ...
          {/* Footer */}
          <div className="mt-6 flex justify-between items-center pt-4 border-t border-gray-200 relative z-10">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 relative z-10"
              >
                Cancel
              </button>
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-md hover:bg-gray-700 relative z-10"
              >
                Start Blank
              </button>
            </div>
